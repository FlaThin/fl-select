...
var _createElement = require("./utils/create-element");
var _replaceTemplate = require("./utils/replace-template");
class Select {
    constructor({ selector, url, placeHolder, templateOption, onSelect }){
    ...
    createOptions(option) {
        const optionElement = (0, _createElement.createHTMLElement)("div", {
            classes: [
        ...
        const contentReplace = (0, _replaceTemplate.replaceTemplate)({
    ...
    createElements() {
        this.input = (0, _createElement.createHTMLElement)("input", {
            classes: [
                "select-input-custom"
            ],
            dataAttributes: {
        ...
        this.optionsWrapper = (0, _createElement.createHTMLElement)("div", {
            classes: [
                "select-wrapper-option-custom"
            ]
        });
        this.labelTrigger = (0, _createElement.createHTMLElement)("div", {
            classes: [
        ...
        this.inputContainer = (0, _createElement.createHTMLElement)("label", {
            classes: [
...
async function simulateRequest(url) {
    return new Promise((resolve, reject)=>{
        setTimeout(()=>{
            ...
            if (sucesso) resolve(fictionalData);
            else reject(new Error(`Falha na requisi\xe7\xe3o para ${url}`));
        }, 1000);
    });
}
...
},{"./utils/create-element":"6vk7d","./utils/replace-template":"eD3aL"}],"6vk7d":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "createHTMLElement", ()=>createHTMLElement);
function createHTMLElement(elementType, options = {}) {
...
},{}],"eD3aL":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "replaceTemplate", ()=>replaceTemplate);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["dZI1r","jeorp"], "jeorp", "parcelRequireb6fa")
